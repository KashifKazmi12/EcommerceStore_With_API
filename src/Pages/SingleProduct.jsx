...
export const SingleProduct = () => {
    ...
    useEffect(()=>{
        let pId = window.location.href.split('/')[4];
        fetchProduct(pId)   // eslint-disable-next-line
    },[]) 
            ...
            <div className="flex flex-wrap -mx-4">
                <div className="w-full px-4 md:w-1/2 ">
                    <div className="sticky top-0 z-50 overflow-hidden ">
                        <div className="relative mb-6 lg:mb-10 lg:h-3/4 ">
                            ...
                            <div className="w-1/2 p-2 sm:w-1/3">
                                <a href={product.image} target='_blank' rel="noreferrer"
                                    ...
                                    <img src={product.image} alt={product.image}
                                        className="object-cover object-top w-full lg:h-36"/>
                                </a>
                            </div>
                            <div className="w-1/2 p-2 sm:w-1/3">
                                <a href={product.image} target='_blank' rel="noreferrer"
                    ...
                    <div className="lg:pl-20">
                        <div className="mb-8 ">
                            ...
                            <div className="flex items-center mb-6">
                                ...
                                <p className="text-xs dark:text-gray-400 "> {4.9} ({300} customer reviews)</p>
                            </div>
                            ...
                            <p className="inline-block mb-8 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                                ...
                                <span
                                    className="text-base font-normal text-gray-500 line-through dark:text-gray-400">${Math.round(product.price+product.price*0.1)}</span>
                            </p>
