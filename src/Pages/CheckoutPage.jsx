        ...
        <div className="container p-12 mx-auto">
            <div className="flex flex-col w-full px-0 mx-auto md:flex-row">
                <div className="flex flex-col md:w-full">
                    ...
                    <form className="justify-center w-full mx-auto" method="post" onSubmit={handleSubmit}>
                        <div className="">
                            ...
                            <div className="mt-4">
                                <button className='mt-6 w-full rounded-md bg-blue-500 py-1.5 font-medium text-blue-50 hover:bg-blue-600' style={{background:'#b13efdee'}}>Process</button>
                            </div>
                        </div>
                    </form>
                </div>
                        ...
                        <div className="mt-8">
                            <div className="flex flex-col space-y-4">
                                <div className="flex space-x-4">
                                    <div>
                                        <img src="https://source.unsplash.com/user/erondu/1600x900" alt="some1"
                                            className="w-60"/>
                                    </div>
                                    <div>
                                ...
                                <div className="flex space-x-4">
                                    <div>
                                        <img src="https://source.unsplash.com/collection/190727/1600x900" alt="some2"
                                            className="w-60"/>
                                    </div>
                                    <div>
                                        <h2 className="text-xl font-bold">Title</h2>
