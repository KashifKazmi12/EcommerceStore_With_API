        ...
        <div className="relative mt-16" style={{ background: 'linear-gradient(to right bottom, #662d8cee ,#ed1e78ea)' }}>
            ...
            <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
                    ...
                    <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-2">
                        <div className="text-left md:text-center">
                            <p className="font-bold text-white tracking-wide text-teal-accent-400 ">
                                Category
                            </p>
                ...
                <div className="flex flex-col justify-between pt-5 pb-10 border-t border-deep-purple-accent-200 sm:flex-row">
                    ...
                    <div className="flex items-center mt-4 space-x-4 sm:mt-0 text-gray-200">
                        <a
                            href="/"
                        ...
                        <a
                            ...
                            className="transition-colors duration-300 text-deep-purple-100 hover:text-blue-400"
                        >
